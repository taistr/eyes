...
class eye(pg.sprite.Sprite):
    def __init__(self, centre, iris_color, iris_radius, pupil_color=None, pupil_radius=None, velocity=None):
        ...
        pg.draw.circle(surface=self.image, color=iris_color, center=(iris_radius, iris_radius), radius=iris_radius)

        #Keep a copy of the iris
        self.iris = self.image 
    ...
    def move(self, up=False, down=False, left=False, right=False):
        #TODO: move the pupil as well but within the iris
...
def main():
    ...
    right_eye = eye(color=pastel_blue, centre=(480, 540), radius=eye_radius, velocity=8)
    left_eye = eye(color=pastel_blue, centre=(1440, 540), radius=eye_radius, velocity=8)
